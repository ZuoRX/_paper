...
#=======================#
#all16中的时间和薪酬是压缩后的数据
all16<-read.csv("C:/Users/lenovo/Desktop/BALL/team-NBA/team16/all16.csv",1)
all16$team1<-gsub("[\u4e00-\u9fa5]+\\d+-\\d+","",all16$pk)#队伍的中文名称简写
all16$team1<-gsub("小牛","独行侠",all16$team1)
...
write.csv(t14,"C:/Users/lenovo/Desktop/BALL/team-NBA/team16/t14.csv")
...
write.csv(s14,"C:/Users/lenovo/Desktop/BALL/team-NBA/team16/s14.csv")
...
#------第三步、导入降维后的t、s------#
#------------------------------------#
#t14-t4 loss: 0.010905063711106777
t4<-read.csv("C:/Users/lenovo/Desktop/BALL/team-NBA/team16/t4.csv")
#s4    loss:  0.0021   054456010460854
s4<-read.csv("C:/Users/lenovo/Desktop/BALL/team-NBA/team16/s4.csv")
...
write.csv(xz1,"C:/Users/lenovo/Desktop/BALL/team-NBA/team16/xz1.csv")
...
write.csv(z2y,"C:/Users/lenovo/Desktop/BALL/team-NBA/team16/z2y.csv")
...
write.csv(e,"C:/Users/lenovo/Desktop/BALL/team-NBA/team16/e.csv")
